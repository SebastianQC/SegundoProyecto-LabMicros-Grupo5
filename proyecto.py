...
valor = raw_input("Ingrese a para empezar: ")
    ...
    while(a):
        ...
        #seccion de codigo que se ejecuta cuando hay deteccion de movimiento y la vigilancia esta activa
            ...
            #seccion para tomar la foto
                ...
                time.sleep(3)#tiempo que hay entre ambos codigos. Para darle tiempo a la imagen de crearse bien y poder ser enviada
                ...
                image = MIMEImage(img_data, name = os.path.basename("/home/pi/home/pi/ProyectoG5/imagen.png"))
                msg.attach(image)
